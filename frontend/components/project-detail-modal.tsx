  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-white via-orange-25 to-gray-50 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto">
          {/* Header */}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">{project.details || project.description}</p>
              ...
              {/* Main Image */}
              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-4">Featured Image</h3>
            ...
            {/* Image Gallery */}
            <div>
              <h3 className="text-xl font-medium text-gray-900 mb-4">Project Gallery</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {images.map((image, index) => (
                  <div
                    key={index}
                    className={`relative cursor-pointer rounded-lg overflow-hidden transition-all duration-200 ${
                      index === selectedImageIndex ? "ring-2 ring-amber-500 ring-offset-2" : "hover:opacity-80"
                    }`}
